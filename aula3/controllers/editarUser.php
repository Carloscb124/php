...
// executa a consulta
$usuario = $con->query($sql)->fetch_assoc();
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark px-3 py-4 mb-4">
        <div class="container d-flex justify-content-between align-items-center">
            <h2 class="text-white m-0">Editar Usuário</h2>
            <a href="../pages/user.php" class="btn btn-outline-light">
        ...
        <div class="card card-modern mx-auto bg-white" style="max-width: 420px;">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nome" class="form-control" placeholder="Digite o nome" required value="<?= $usuario['nome'] ?>">
                </div>

                <div class="mb-3">
                    <label class="label-modern">Email</label>
                    <input type="email" name="email" class="form-control" placeholder="Digite o email" required value="<?= $usuario['email'] ?>">
                </div>

                <div class="mb-3">
                    <label class="label-modern">Senha</label>
                    <input type="password" name="senha" class="form-control" placeholder="Digite sua senha" required value="<?= $usuario['senha'] ?>">
                </div>
